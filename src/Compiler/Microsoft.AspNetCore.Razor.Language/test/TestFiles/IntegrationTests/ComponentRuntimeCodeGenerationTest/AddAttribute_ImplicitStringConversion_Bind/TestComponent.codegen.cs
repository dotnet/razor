...
namespace __Blazor.Test.TestComponent
{
    ...
    internal static class TypeInference
    {
        ...
        __builder.AddComponentParameter(__seq0, "BoolParameter", __arg0);
        __builder.AddComponentParameter(__seq1, "StringParameter", __arg1);
        __builder.AddComponentParameter(__seq2, "DelegateParameter", __arg2);
        __builder.AddComponentParameter(__seq3, "ObjectParameter", __arg3);
        __builder.AddComponentParameter(__seq4, "MyParameter", __arg4);
        __builder.AddComponentParameter(__seq5, "MyParameterChanged", __arg5);
