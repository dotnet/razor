...
public class CSharpCodeWriterTest
{
    ...
    public void WriteField_WritesFieldDeclaration()
    {
        ...
        // Act
        writer.WriteField(suppressWarnings: [], ["private"], "global::System.String", "_myString");
    ...
    public void WriteField_WithModifiers_WritesFieldDeclaration()
    {
        ...
        // Act
        writer.WriteField(suppressWarnings: [], ["private", "readonly", "static"], "global::System.String", "_myString");
    ...
    public void CSharpCodeWriter_RespectTabSetting()
    {
        ...
        // Act
        writer.BuildClassDeclaration(modifiers: [], "C", null, interfaces: [], typeParameters: [], context);
        writer.WriteField(suppressWarnings: [], modifiers: [], "int", "f");
