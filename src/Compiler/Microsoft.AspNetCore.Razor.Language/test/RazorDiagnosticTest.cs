...
public class RazorDiagnosticTest
{
    ...
    public void DefaultRazorDiagnostic_GetMessage_WithArgs()
    {
        ...
        var diagnostic = RazorDiagnostic.Create(descriptor, span, new[] { "error" });
    ...
    public void DefaultRazorDiagnostic_GetMessage_WithArgs_FormatProvider()
    {
        ...
        var diagnostic = RazorDiagnostic.Create(descriptor, span, new object[] { 1.3m });
    ...
    public void DefaultRazorDiagnostic_ToString()
    {
        ...
        var diagnostic = RazorDiagnostic.Create(descriptor, span, new object[0]);
    ...
    public void DefaultRazorDiagnostic_Equals()
    {
        ...
        var diagnostic1 = RazorDiagnostic.Create(descriptor, span, new object[0]);
        var diagnostic2 = RazorDiagnostic.Create(descriptor, span, new object[0]);
    ...
    public void DefaultRazorDiagnostic_NotEquals_DifferentLocation()
    {
        ...
        var diagnostic1 = RazorDiagnostic.Create(descriptor, span1, new object[0]);
        var diagnostic2 = RazorDiagnostic.Create(descriptor, span2, new object[0]);
    ...
    public void DefaultRazorDiagnostic_NotEquals_DifferentId()
    {
        ...
        var diagnostic1 = RazorDiagnostic.Create(descriptor1, span, new object[0]);
        var diagnostic2 = RazorDiagnostic.Create(descriptor2, span, new object[0]);
