...
// Copied from https://github.com/dotnet/roslyn/blob/565f8b4073b821d9d1d85859f8b34908f5a3d17d/src/Compilers/Test/Core/Assert/AssertEx.cs,
// with minor changes to disable warnings and remove non-compiling code

#pragma warning disable IDE0161 // Convert to file-scoped namespaces
...
namespace Roslyn.Test.Utilities
{
    ...
    public static class AssertEx
    {
            ...
            int expectedValueSourceLine = 0)
        {
            ...
            var expectedString = join(itemSeparator, expected.Slice(0, Math.Min(expected.Length, maxDisplayedExpectedEntries)), itemInspector);
        ...
        public static void Multiple(bool includeStackTrace, params Action[] assertions)
        {
            ...
            foreach (var (index, ex) in exceptions)
            {
                ...
                stringBuilder
                    ...
                    .AppendLine(stack[stack.Length - 2]) // Prints the failing line in the original test case.
