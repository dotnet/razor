...
");
            ...
            result.VerifyHostOutput(
                (@"Pages_Index_razor.g.cs.rsg-cs", @"// <auto-generated/>
#pragma warning disable 1591
namespace MyApp.Pages
{
    #line hidden
...
#pragma warning restore 1591
"),
                (@"Pages_Index_razor.g.cs.rsg-html", @"<h1>Hello world</h1>"));
...
");
            ...
            Assert.Collection(eventListener.Events,
                ...
                e =>
                {
                    ...
                    Assert.Equal(new[] { "/Pages/Index.razor", "Runtime" }, e.Payload);
                },
                e =>
                {
                ...
                {
                    Assert.Equal("RazorCodeGenerateStart", e.EventName);
                    Assert.Equal(new[] { "/Pages/Counter.razor", "Runtime" }, e.Payload);
                },
                e =>
                {
                    Assert.Equal("RazorCodeGenerateStop", e.EventName);
...
");
            ...
            Assert.Collection(eventListener.Events,
                ...
                {
                    Assert.Equal("RazorCodeGenerateStart", e.EventName);
                    Assert.Equal(new[] { "/Pages/Index.cshtml", "Runtime" }, e.Payload);
                },
                e =>
                {
                    Assert.Equal("RazorCodeGenerateStop", e.EventName);
                ...
                {
                    Assert.Equal("RazorCodeGenerateStart", e.EventName);
                    Assert.Equal(new[] { "/Views/Shared/_Layout.cshtml", "Runtime" }, e.Payload);
                },
                e =>
                {
                    Assert.Equal("RazorCodeGenerateStop", e.EventName);
...
");
        ...
        private static async ValueTask<(GeneratorDriver, ImmutableArray<AdditionalText>, TestAnalyzerConfigOptionsProvider)> GetDriverWithAdditionalTextAndProviderAsync(Project project, Action<TestAnalyzerConfigOptionsProvider>? configureGlobalOptions = null, bool hostOutputs = false)
        {
