...
");
        ...
        public async Task SourceGenerator_RazorFiles_DesignTime()
        {
            ...
            result.VerifyDesignTimePageOutput(
@"// <auto-generated/>
#pragma warning disable 1591
namespace MyApp.Pages
{
...
");
            ...
            result.VerifyHostOutput((@"Pages_Index_razor.g.cs.rsg-html", @"<h1>Hello world</h1>"));
...
");
    ...
    internal static class Extensions
    {
        ...
        {
            return result.VerifyPageOutputCore(trimChecksum: true, expectedOutput);
        }

        public static GeneratorRunResult VerifyDesignTimePageOutput(this GeneratorRunResult result, params string[] expectedOutput)
        {
            return result.VerifyPageOutputCore(trimChecksum: false, expectedOutput);
        }

        private static GeneratorRunResult VerifyPageOutputCore(this GeneratorRunResult result, bool trimChecksum, string[] expectedOutput)
        {
            if (expectedOutput.Length == 1 && string.IsNullOrWhiteSpace(expectedOutput[0]))
            {
                GenerateExpectedPageOutput(result);
            }
            else
            {
                ...
                for (int i = 0; i < result.GeneratedSources.Length; i++)
                {
                    ...
                    var actual = result.GeneratedSources[i].SourceText.ToString();

                    if (trimChecksum)
                    {
                        expected = TrimChecksum(expected);
                        actual = TrimChecksum(actual);
                    }
        ...
        public static GeneratorRunResult VerifyHostOutput(this GeneratorRunResult result, params (string hintName, string text)[] expectedOutputs)
        {
            ...
            {
                GenerateExpectedHostOutput(result);
            }
            else
            {
        ...
        private static void GenerateExpectedPageOutput(GeneratorRunResult result)
        {
        ...
        private static void GenerateExpectedHostOutput(GeneratorRunResult result)
        {
