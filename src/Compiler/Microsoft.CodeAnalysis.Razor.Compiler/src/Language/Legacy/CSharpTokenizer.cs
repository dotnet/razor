...
internal class CSharpTokenizer : Tokenizer
{
    ...
    private static readonly Dictionary<string, CSharpSyntaxKind> _keywords = new Dictionary<string, CSharpSyntaxKind>(StringComparer.Ordinal)
        {
            { "await", CSharpSyntaxKind.AwaitKeyword },
            { "abstract", CSharpSyntaxKind.AbstractKeyword },
            { "byte", CSharpSyntaxKind.ByteKeyword },
            { "class", CSharpSyntaxKind.ClassKeyword },
            { "delegate", CSharpSyntaxKind.DelegateKeyword },
            { "event", CSharpSyntaxKind.EventKeyword },
            { "fixed", CSharpSyntaxKind.FixedKeyword },
            { "if", CSharpSyntaxKind.IfKeyword },
            { "internal", CSharpSyntaxKind.InternalKeyword },
            { "new", CSharpSyntaxKind.NewKeyword },
            { "override", CSharpSyntaxKind.OverrideKeyword },
            { "readonly", CSharpSyntaxKind.ReadOnlyKeyword },
            { "short", CSharpSyntaxKind.ShortKeyword },
            { "struct", CSharpSyntaxKind.StructKeyword },
            { "try", CSharpSyntaxKind.TryKeyword },
            { "unsafe", CSharpSyntaxKind.UnsafeKeyword },
            { "volatile", CSharpSyntaxKind.VolatileKeyword },
            { "as", CSharpSyntaxKind.AsKeyword },
            { "do", CSharpSyntaxKind.DoKeyword },
            { "is", CSharpSyntaxKind.IsKeyword },
            { "params", CSharpSyntaxKind.ParamsKeyword },
            { "ref", CSharpSyntaxKind.RefKeyword },
            { "switch", CSharpSyntaxKind.SwitchKeyword },
            { "ushort", CSharpSyntaxKind.UShortKeyword },
            { "while", CSharpSyntaxKind.WhileKeyword },
            { "case", CSharpSyntaxKind.CaseKeyword },
            { "const", CSharpSyntaxKind.ConstKeyword },
            { "explicit", CSharpSyntaxKind.ExplicitKeyword },
            { "float", CSharpSyntaxKind.FloatKeyword },
            { "null", CSharpSyntaxKind.NullKeyword },
            { "sizeof", CSharpSyntaxKind.SizeOfKeyword },
            { "typeof", CSharpSyntaxKind.TypeOfKeyword },
            { "implicit", CSharpSyntaxKind.ImplicitKeyword },
            { "private", CSharpSyntaxKind.PrivateKeyword },
            { "this", CSharpSyntaxKind.ThisKeyword },
            { "using", CSharpSyntaxKind.UsingKeyword },
            { "extern", CSharpSyntaxKind.ExternKeyword },
            { "return", CSharpSyntaxKind.ReturnKeyword },
            { "stackalloc", CSharpSyntaxKind.StackAllocKeyword },
            { "uint", CSharpSyntaxKind.UIntKeyword },
            { "base", CSharpSyntaxKind.BaseKeyword },
            { "catch", CSharpSyntaxKind.CatchKeyword },
            { "continue", CSharpSyntaxKind.ContinueKeyword },
            { "double", CSharpSyntaxKind.DoubleKeyword },
            { "for", CSharpSyntaxKind.ForKeyword },
            { "in", CSharpSyntaxKind.InKeyword },
            { "lock", CSharpSyntaxKind.LockKeyword },
            { "object", CSharpSyntaxKind.ObjectKeyword },
            { "protected", CSharpSyntaxKind.ProtectedKeyword },
            { "static", CSharpSyntaxKind.StaticKeyword },
            { "false", CSharpSyntaxKind.FalseKeyword },
            { "public", CSharpSyntaxKind.PublicKeyword },
            { "sbyte", CSharpSyntaxKind.SByteKeyword },
            { "throw", CSharpSyntaxKind.ThrowKeyword },
            { "virtual", CSharpSyntaxKind.VirtualKeyword },
            { "decimal", CSharpSyntaxKind.DecimalKeyword },
            { "else", CSharpSyntaxKind.ElseKeyword },
            { "operator", CSharpSyntaxKind.OperatorKeyword },
            { "string", CSharpSyntaxKind.StringKeyword },
            { "ulong", CSharpSyntaxKind.ULongKeyword },
            { "bool", CSharpSyntaxKind.BoolKeyword },
            { "char", CSharpSyntaxKind.CharKeyword },
            { "default", CSharpSyntaxKind.DefaultKeyword },
            { "foreach", CSharpSyntaxKind.ForEachKeyword },
            { "long", CSharpSyntaxKind.LongKeyword },
            { "void", CSharpSyntaxKind.VoidKeyword },
            { "enum", CSharpSyntaxKind.EnumKeyword },
            { "finally", CSharpSyntaxKind.FinallyKeyword },
            { "int", CSharpSyntaxKind.IntKeyword },
            { "out", CSharpSyntaxKind.OutKeyword },
            { "sealed", CSharpSyntaxKind.SealedKeyword },
            { "true", CSharpSyntaxKind.TrueKeyword },
            { "goto", CSharpSyntaxKind.GotoKeyword },
            { "unchecked", CSharpSyntaxKind.UncheckedKeyword },
            { "interface", CSharpSyntaxKind.InterfaceKeyword },
            { "break", CSharpSyntaxKind.BreakKeyword },
    ...
    private StateResult Identifier()
    {
        ...
        if (HaveContent)
        {
            ...
            if (_keywords.TryGetValue(tokenContent, out _))
            {
