...
{
    private static readonly ImmutableArray<string> s_fieldUnintializedModifiers = ["0649"];
    ...
    public void WriteTagHelperRuntime(CodeRenderingContext context, DefaultTagHelperRuntimeIntermediateNode node)
    {
        ...
        context.CodeWriter.WriteField(s_fieldUnintializedModifiers, s_privateModifiers, ExecutionContextTypeName, ExecutionContextVariableName);
