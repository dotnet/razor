...
internal class ComponentDocumentClassifierPass : DocumentClassifierPassBase
{
        ...
        MethodDeclarationIntermediateNode method)
    {
        ...
        if (FileKinds.IsComponentImport(codeDocument.GetFileKind()))
        {
            ...
            @class.BaseType = new BaseTypeIntermediateNode(typeof(object).FullName);
        ...
        {
            @class.BaseType = new BaseTypeIntermediateNode("global::" + ComponentsApi.ComponentBase.FullTypeName);
