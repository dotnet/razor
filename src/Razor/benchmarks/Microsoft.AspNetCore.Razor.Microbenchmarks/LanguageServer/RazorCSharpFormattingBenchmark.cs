...
";
    ...
    public async Task RazorCSharpFormattingAsync()
    {
        ...
        var edits = await RazorFormattingService.GetDocumentFormattingEditsAsync(documentContext, [], range: null, RazorFormattingOptions.Default, CancellationToken.None);
