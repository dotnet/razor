...
internal static class VisualStudioLogging
{
    ...
    {
        // There could be multiple copies of visual studio installed, each with their own Exp hive
        ...
        // that case it will fall back to the previous behavior of expecting a single Exp hive to
        // exist, or fail.
        var directories = Directory.GetDirectories(vsLocalDir, $"17*{installationId}Exp", SearchOption.TopDirectoryOnly);
