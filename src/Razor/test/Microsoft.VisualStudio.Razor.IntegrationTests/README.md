...
- If you're suddenly seeing strange packaging issues it's likely your "Hive" is corrupted somehow. I recommend deleting all the folders containing `Exp` from `AppData\Local\Microsoft\VisualStudio`
