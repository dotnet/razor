...
From Visual Studio:
- Open Test Explorer and run tests from the `Microsoft.VisualStudioCode.Razor.E2ETests` project
...
- **VSCodeFixture**: xUnit fixture that manages VS Code lifecycle (download, launch, connect, cleanup)
- **VSCodeEditor**: Helper methods for editor operations (typing, navigation, completions, hover, etc.)
- **RazorEditorHelpers**: Razor-specific helpers for verifying IntelliSense, diagnostics, etc.
