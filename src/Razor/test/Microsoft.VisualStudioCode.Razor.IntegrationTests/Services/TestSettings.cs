...
{
    /// <summary>
    /// Path to the VS Code executable. If null, will download and install locally.
    /// </summary>
    public string? VSCodePath { get; set; }

    /// <summary>
    /// Whether to use VS Code Insiders instead of stable.
    /// </summary>
    ...
    /// Can be overridden via the RAZOR_TEST_CONFIGURATION environment variable.
    /// </summary>
    public string Configuration { get; set; } = Environment.GetEnvironmentVariable("RAZOR_TEST_CONFIGURATION") ?? "Debug";
