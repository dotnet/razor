...
public class RazorCustomMessageTargetTest : TestBase
{
    ...
    public async Task ProvideCodeActionsAsync_ReturnsCodeActionsAsync()
    {
        ...
        var target = new RazorCustomMessageTarget(
                ...
                TestFormattingOptionsProvider.Default, _editorSettingsManager, documentSynchronizer, csharpVirtualDocumentAddListener, telemetryReporter.Object, TestLanguageServerFeatureOptions.Instance, Mock.Of<ProjectSnapshotManagerAccessor>(MockBehavior.Strict), Mock.Of<SnippetCache>(MockBehavior.Strict), null);
    ...
    public async Task ResolveCodeActionsAsync_ReturnsSingleCodeAction()
    {
        ...
        var target = new RazorCustomMessageTarget(
            ...
            TestFormattingOptionsProvider.Default, _editorSettingsManager, documentSynchronizer.Object, csharpVirtualDocumentAddListener, telemetryReporter.Object, TestLanguageServerFeatureOptions.Instance, Mock.Of<ProjectSnapshotManagerAccessor>(MockBehavior.Strict), Mock.Of<SnippetCache>(MockBehavior.Strict), null);
