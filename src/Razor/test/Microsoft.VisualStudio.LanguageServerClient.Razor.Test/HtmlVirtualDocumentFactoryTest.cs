...
namespace Microsoft.VisualStudio.LanguageServerClient.Razor
{
    public class HtmlVirtualDocumentFactoryTest
    {
        ...
        public void TryCreateFor_NonRazorLSPBuffer_ReturnsFalse()
        {
            ...
            var factory = new HtmlVirtualDocumentFactory(ContentTypeRegistry, TextBufferFactory, TextDocumentFactoryService, uriProvider, TestLanguageServerFeatureOptions.Instance);
