...
public class CSharpVirtualDocumentFactoryTest : ToolingTestBase
{
    ...
    public void TryCreateMultipleFor_NonRazorLSPBuffer_ReturnsFalse()
    {
        ...
        var factory = new CSharpVirtualDocumentFactory(_contentTypeRegistryService, _textBufferFactoryService, TextDocumentFactoryService, uriProvider, _filePathService, projectSnapshotManagerAccessor, TestLanguageServerFeatureOptions.Instance, TestOutputWindowLogger.Instance, telemetryReporter: null);
    ...
    public void TryCreateMultipleFor_RazorLSPBuffer_ReturnsMultipleCSharpVirtualDocumentsAndTrue()
    {
        ...
        var factory = new CSharpVirtualDocumentFactory(_contentTypeRegistryService, _textBufferFactoryService, TextDocumentFactoryService, uriProvider, filePathService, projectSnapshotManagerAccessor, languageServerFeatureOptions, TestOutputWindowLogger.Instance, telemetryReporter: null);
