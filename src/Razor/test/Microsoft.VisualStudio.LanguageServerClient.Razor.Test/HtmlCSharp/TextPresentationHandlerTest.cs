...
{
    public class TextPresentationHandlerTest : HandlerTestBase
    {
        public TextPresentationHandlerTest()
        {
        ...
        public async Task HandleRequestAsync_DocumentNotFound_ReturnsNull()
        {
            ...
            var handler = new TextPresentationHandler(requestInvoker, documentManager, projectionProvider, documentMappingProvider, LoggerProvider);
        ...
        public async Task HandleRequestAsync_HtmlProjection_InvokesHtmlLanguageServer()
        {
            ...
            requestInvoker
                .Setup(r => r.ReinvokeRequestOnServerAsync<VSInternalTextPresentationParams, WorkspaceEdit>(
                    It.IsAny<ITextBuffer>(),
                    It.IsAny<string>(),
                    It.IsAny<string>(),
                    It.IsAny<VSInternalTextPresentationParams>(),
                    It.IsAny<CancellationToken>()))
                .Callback<ITextBuffer, string, string, VSInternalTextPresentationParams, CancellationToken>((textBuffer, method, clientName, hoverParams, ct) =>
                {
                    Assert.Equal(VSInternalMethods.TextDocumentTextPresentationName, method);
            ...
            var handler = new TextPresentationHandler(requestInvoker.Object, DocumentManager, projectionProvider.Object, documentMappingProvider.Object, LoggerProvider);
