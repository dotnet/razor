...
public class RazorContentTypeChangeListenerTest : ToolingTestBase
{
        ...
        IFileToContentTypeService fileToContentTypeService = null)
    {
        ...
        lspEditorFeatureDetector ??= Mock.Of<ILspEditorFeatureDetector>(detector => detector.IsLspEditorAvailable(It.IsAny<string>()) == true && detector.IsRemoteClient() == false, MockBehavior.Strict);
