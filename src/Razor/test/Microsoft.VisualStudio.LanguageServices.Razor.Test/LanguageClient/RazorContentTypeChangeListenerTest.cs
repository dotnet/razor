...
public class RazorContentTypeChangeListenerTest : ToolingTestBase
{
        ...
        IFileToContentTypeService fileToContentTypeService = null)
    {
        ...
        lspEditorFeatureDetector ??= Mock.Of<ILspEditorFeatureDetector>(detector => detector.IsLSPEditorAvailable() == true && detector.IsRemoteClient() == false, MockBehavior.Strict);
