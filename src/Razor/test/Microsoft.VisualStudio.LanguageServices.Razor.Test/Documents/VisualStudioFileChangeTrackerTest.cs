    ...
    public class VisualStudioFileChangeTrackerTest : ForegroundDispatcherTestBase
    {
        ...
        public async Task StartListening_AdvisesForFileChange()
        {
            ...
            fileChangeService
                ...
                .Verifiable();
            var tracker = new VisualStudioFileChangeTracker(TestProjectData.SomeProjectImportFile.FilePath, ErrorReporter, fileChangeService.Object, Dispatcher, JoinableTaskContext);
        ...
        public async Task FilesChanged_WithSpecificFlags_InvokesChangedHandler_WithExpectedArguments(uint fileChangeFlag, int expectedKind)
        {
            ...
            var tracker = new VisualStudioFileChangeTracker(filePath, ErrorReporter, fileChangeService, Dispatcher, JoinableTaskContext);
