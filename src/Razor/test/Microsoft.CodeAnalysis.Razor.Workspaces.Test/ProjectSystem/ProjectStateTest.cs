...
public class ProjectStateTest : WorkspaceTestBase
{
    ...
    {
        // Arrange
        var original = ProjectState.Create(_hostProject, _projectWorkspaceState, CompilerOptions, ProjectEngineFactoryProvider);
    ...
    public void ProjectState_AddDocument_ToProjectWithDocuments()
    {
        ...
        var original = ProjectState
            .Create(_hostProject, _projectWorkspaceState, CompilerOptions, ProjectEngineFactoryProvider)
