...
public class ProjectStateGeneratedOutputTest : WorkspaceTestBase
{
    ...
    public async Task AddDocument_CachesOutput()
    {
        ...
        // Act
        var state = original.AddDocument(TestProjectData.AnotherProjectFile1, EmptyTextLoader.Instance);
    ...
    public async Task AddDocument_Import_DoesNotCacheOutput()
    {
        ...
        // Act
        var state = original.AddDocument(TestProjectData.SomeProjectImportFile, EmptyTextLoader.Instance);
    ...
    public async Task WithProjectWorkspaceState_CSharpLanguageVersionChange_DoesNotCacheOutput()
    {
        ...
        var original = ProjectState
            .Create(hostProject, originalWorkspaceState, CompilerOptions, ProjectEngineFactoryProvider)
