...
public class ProjectStateGeneratedOutputTest : WorkspaceTestBase
{
    ...
    {
        // Arrange
        var csharp8ValidConfiguration = new RazorConfiguration(RazorLanguageVersion.Version_3_0, _hostProject.Configuration.ConfigurationName, _hostProject.Configuration.Extensions, RazorLanguageFeatureFlags.Default);
