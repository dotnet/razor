...
public sealed class VSDocumentPullDiagnosticsEndpointTest(ITestOutputHelper testOutput) : LanguageServerTestBase(testOutput)
{
    [Fact]
    public void ApplyCapabilities_AddsExpectedCapabilities()
    {
        ...
        var endpoint = new VSDocumentPullDiagnosticsEndpoint(
