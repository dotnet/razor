...
public class FindNodeTests(ITestOutputHelper testOutput) : ToolingTestBase(testOutput)
{
    ...
    [InlineData(234, 265, SyntaxKind.CSharpStatementLiteral, false)]
    [InlineData(234, 265, SyntaxKind.CSharpStatementLiteral, true)]
    ...
    [InlineData(293, 309, SyntaxKind.CSharpStatementLiteral, false)]
    [InlineData(293, 309, SyntaxKind.CSharpStatementLiteral, true)]
    ...
    [InlineData(571, 639, SyntaxKind.CSharpStatementLiteral, false)]
    [InlineData(571, 639, SyntaxKind.CSharpStatementLiteral, true)]
