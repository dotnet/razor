...
public class FindNodeTests(ITestOutputHelper testOutput) : ToolingTestBase(testOutput)
{
    ...
    [InlineData(41, 43, SyntaxKind.MarkupTextLiteral, true)]
    ...
    [InlineData(234, 259, SyntaxKind.CSharpStatementLiteral, false)]
    [InlineData(234, 259, SyntaxKind.CSharpStatementLiteral, true)]
    [InlineData(265, 268, SyntaxKind.MarkupStartTag, false)]
    [InlineData(259, 265, SyntaxKind.MarkupTextLiteral, true)]
    ...
    [InlineData(293, 303, SyntaxKind.CSharpStatementLiteral, false)]
    [InlineData(293, 303, SyntaxKind.CSharpStatementLiteral, true)]
    [InlineData(309, 330, SyntaxKind.MarkupStartTag, false)]
    [InlineData(303, 309, SyntaxKind.MarkupTextLiteral, true)]
    ...
    [InlineData(571, 621, SyntaxKind.CSharpStatementLiteral, false)]
    [InlineData(571, 621, SyntaxKind.CSharpStatementLiteral, true)]
    [InlineData(639, 643, SyntaxKind.MarkupStartTag, false)]
    [InlineData(621, 639, SyntaxKind.MarkupTextLiteral, true)]
    ...
    [InlineData(887, 900, SyntaxKind.CSharpStatementLiteral, false)]
    [InlineData(887, 900, SyntaxKind.CSharpStatementLiteral, true)]
    [InlineData(910, 918, SyntaxKind.MarkupEndTag, false)]
    [InlineData(900, 910, SyntaxKind.MarkupTextLiteral, true)]
    ...
    [InlineData(934, 935, SyntaxKind.CSharpStatementLiteral, false)]
    [InlineData(934, 935, SyntaxKind.CSharpStatementLiteral, true)]
    [InlineData(939, 940, SyntaxKind.CSharpTransition, false)]
    [InlineData(935, 939, SyntaxKind.MarkupTextLiteral, true)]
