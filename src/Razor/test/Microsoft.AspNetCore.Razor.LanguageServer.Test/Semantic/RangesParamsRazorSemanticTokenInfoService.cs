...
[IntializeTestFile]
[UseExportProvider]
internal class RangesParamsRazorSemanticTokenInfoService : RazorSemanticTokenInfoServiceTest
{
    public RangesParamsRazorSemanticTokenInfoService(ITestOutputHelper testOutput)
