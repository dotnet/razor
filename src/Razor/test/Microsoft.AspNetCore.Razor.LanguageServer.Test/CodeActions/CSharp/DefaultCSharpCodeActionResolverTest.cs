...
public class DefaultCSharpCodeActionResolverTest : LanguageServerTestBase
{
    ...
    private static ClientNotifierServiceBase CreateLanguageServer(CodeAction? resolvedCodeAction = null)
    {
        ...
        languageServer
            .Setup(l => l.SendRequestAsync<RazorResolveCodeActionParams, CodeAction>(RazorCustomLSPMethodNames.RazorResolveCodeActionsEndpoint, It.IsAny<RazorResolveCodeActionParams>(), It.IsAny<CancellationToken>()))
