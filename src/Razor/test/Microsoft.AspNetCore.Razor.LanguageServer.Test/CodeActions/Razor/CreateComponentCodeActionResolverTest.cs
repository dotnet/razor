...
namespace Microsoft.AspNetCore.Razor.LanguageServer.CodeActions
{
    public class CreateComponentCodeActionResolverTest : LanguageServerTestBase
    {
        ...
        {
            // Arrange
            var resolver = new CreateComponentCodeActionResolver(new DefaultSingleThreadedDispatcher(), EmptyDocumentResolver);
        ...
        public async Task Handle_Unsupported()
        {
            ...
            var resolver = new CreateComponentCodeActionResolver(new DefaultSingleThreadedDispatcher(), CreateDocumentResolver(documentPath, codeDocument));
            var data = JObject.FromObject(new CreateComponentCodeActionParams()
            {
