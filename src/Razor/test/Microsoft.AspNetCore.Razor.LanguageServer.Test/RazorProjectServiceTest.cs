...
#nullable enable
    ...
    public async Task IProjectInfoListener_UpdatedAsync_UpdatingDocument_MapsRelativeFilePathToActualDocument()
    {
        ...
        var newDocument = new HostDocument("file.cshtml", "file.cshtml", FileKinds.Component);
    ...
    public async Task IProjectInfoListener_UpdatedAsync_AddsNewDocuments()
    {
        ...
        var oldDocument = new HostDocument(hostDocument.FilePath, hostDocument.TargetPath, hostDocument.FileKind);
        var newDocument = new HostDocument("C:/path/to/file2.cshtml", "file2.cshtml", FileKinds.Legacy);
    ...
    public async Task IProjectInfoListener_UpdatedAsync_MovesDocumentsFromMisc()
    {
        ...
        var addedDocument = new HostDocument(hostDocument.FilePath, hostDocument.TargetPath, hostDocument.FileKind);
    ...
    public async Task IProjectInfoListener_UpdatedAsync_MovesDocumentsFromMisc_ViaService()
    {
        ...
        var ownerProjectKey = await _projectService.AddProjectAsync(hostProject, DisposalToken);
    ...
    public async Task IProjectInfoListener_UpdatedAsync_KnownDocuments()
    {
        ...
        var newDocument = new HostDocument(document.FilePath, document.TargetPath, document.FileKind);
    ...
    public async Task IProjectInfoListener_UpdatedAsync_UpdatesLegacyDocumentsAsComponents()
    {
        ...
        var newDocument = new HostDocument(legacyDocument.FilePath, legacyDocument.TargetPath, FileKinds.Component);
    ...
    public async Task CloseDocument_ClosesDocumentInAllOwnerProjects()
    {
        ...
        var hostProject1 = new HostProject(ProjectFilePath, IntermediateOutputPath1, RazorConfiguration.Default, RootNamespace);
        var hostProject2 = new HostProject(ProjectFilePath, IntermediateOutputPath2, RazorConfiguration.Default, RootNamespace);

        var ownerProjectKey1 = await _projectService.AddProjectAsync(hostProject1, DisposalToken);
        var ownerProjectKey2 = await _projectService.AddProjectAsync(hostProject2, DisposalToken);
        await _projectService.AddDocumentToPotentialProjectsAsync(DocumentFilePath, DisposalToken);
        await _projectService.OpenDocumentAsync(DocumentFilePath, s_emptyText, DisposalToken);
    ...
    public async Task AddDocumentToMiscProjectAsync_IgnoresKnownDocument()
    {
        ...
        await _projectService.AddProjectAsync(hostProject, DisposalToken);
        await _projectService.AddDocumentToPotentialProjectsAsync(DocumentFilePath, DisposalToken);
