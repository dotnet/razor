...
";
            ...
            var importsDocument = SourceText.From(defaultImports).GetRazorSourceDocument(importsPath, importsPath);
        ...
        protected static IReadOnlyList<TagHelperDescriptor> GetDefaultRuntimeComponents()
        {
