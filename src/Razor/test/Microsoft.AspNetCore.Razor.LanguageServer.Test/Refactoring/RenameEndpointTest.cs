...
public class RenameEndpointTest : LanguageServerTestBase
{
    ...
    public async Task Handle_Rename_SingleServer_CallsDelegatedLanguageServer()
    {
        ...
        languageServerMock
            .Setup(c => c.SendRequestAsync<IDelegatedParams, WorkspaceEdit>(RazorCustomLSPMethodNames.RazorRenameEndpointName, It.IsAny<DelegatedRenameParams>(), It.IsAny<CancellationToken>()))
