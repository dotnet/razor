...
public class RenameEndpointTest : LanguageServerTestBase
{
    ...
    private RenameEndpoint CreateEndpoint(LanguageServerFeatureOptions languageServerFeatureOptions = null, IRazorDocumentMappingService documentMappingService = null, IClientNotifierService languageServer = null)
    {
