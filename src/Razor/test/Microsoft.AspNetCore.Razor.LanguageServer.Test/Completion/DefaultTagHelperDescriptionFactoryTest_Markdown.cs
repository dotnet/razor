...
{
    public class DefaultTagHelperDescriptionFactoryTest_Markdown : DefaultTagHelperDescriptionFactoryTestBase
    {
        [Fact]
...
World", cleanedSummary);
        ...
        {
            // Arrange
            var descriptionFactory = new DefaultTagHelperTooltipFactory(GetLanguageServer());
