...
public class DelegatedCompletionItemResolverTest : LanguageServerTestBase
{
        ...
        : base(testOutput)
    {
        ...
        _htmlCompletionParams = new DelegatedCompletionParams(documentContext.Identifier, VsLspFactory.EmptyPosition, RazorLanguageKind.Html, new VSInternalCompletionContext(), ProvisionalTextEdit: null, ShouldIncludeSnippets: false, CorrelationId: Guid.Empty);
