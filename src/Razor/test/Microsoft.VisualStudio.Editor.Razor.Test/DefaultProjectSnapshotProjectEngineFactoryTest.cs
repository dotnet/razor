...
public class DefaultProjectSnapshotProjectEngineFactoryTest : ToolingTestBase
{
        ...
        : base(testOutput)
    {
        ...
        var hostProject_For_2_1 = new HostProject(
            ...
            new(RazorLanguageVersion.Version_2_1, "MVC-2.1", Extensions: [], RazorLanguageFeatureFlags.Default), "Test");

        var hostProject_For_3_0 = new HostProject(
            projectFilePath, intermediateOutputPath,
            new(RazorLanguageVersion.Version_3_0, "MVC-3.0", Extensions: [], RazorLanguageFeatureFlags.Default), "Test");

        var hostProject_For_UnknownConfiguration = new HostProject(
            projectFilePath, intermediateOutputPath,
            new(RazorLanguageVersion.Version_2_1, "Random-0.1", Extensions: [], RazorLanguageFeatureFlags.Default), rootNamespace: null);
