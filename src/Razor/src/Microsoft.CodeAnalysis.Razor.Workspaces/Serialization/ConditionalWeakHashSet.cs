...
namespace Microsoft.CodeAnalysis.Razor.Serialization
{
        ...
        where TValue : class?
    {
        ...
        /// </remarks>
        public TKey GetValue(TKey key, CreateValueCallback createValueCallback)
        {
        ...
        public delegate TKey CreateValueCallback(TKey key);
                ...
                if (table != null)
                {
                    ...
                    lock (table._lock)
                    {
                        ...
                        if (c != null)
                        {
                            ...
                            {
                                _currentIndex++;
                                if (c.TryGetEntry(_currentIndex, out TKey key))
                                {
                                    _current = new KeyValuePair<TKey, TValue>(key, null);
                                    return true;
                                }
                            }
                        }
            ...
            internal Container Resize(int newSize)
            {
                ...
                else
                {
                    ...
                    for (int entriesIndex = 0; entriesIndex < _entries.Length; entriesIndex++)
                    {
                        ...
                        int hashCode = oldEntry.HashCode;
                        WeakReference<TKey> depHnd = oldEntry.depHnd;
            ...
            ~Container()
            {
                ...
                if (entries != null)
                {
                    for (int entriesIndex = 0; entriesIndex < entries.Length; entriesIndex++)
                    {
                        ...
                        {
                            entries[entriesIndex].depHnd = null;
                        }
                    }
                }
            }
