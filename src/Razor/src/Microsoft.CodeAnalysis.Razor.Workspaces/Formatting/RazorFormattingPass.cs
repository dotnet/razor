    ...
    : FormattingPassBase(documentMappingService)
{
    ...
    private static void TryFormatBlocks(FormattingContext context, List<TextEdit> edits, RazorSourceDocument source, AspNetCore.Razor.Language.Syntax.SyntaxNode node)
    {
    ...
    private static bool TryFormatFunctionsBlock(FormattingContext context, IList<TextEdit> edits, RazorSourceDocument source, AspNetCore.Razor.Language.Syntax.SyntaxNode node)
    {
        // @functions
        // {
        // }
    ...
    private static bool FormatBlock(FormattingContext context, RazorSourceDocument source, AspNetCore.Razor.Language.Syntax.SyntaxNode? directiveNode, AspNetCore.Razor.Language.Syntax.SyntaxNode openBraceNode, AspNetCore.Razor.Language.Syntax.SyntaxNode codeNode, AspNetCore.Razor.Language.Syntax.SyntaxNode closeBraceNode, IList<TextEdit> edits)
    {
        var didFormat = false;
