...
[RazorLanguageServerEndpoint(LanguageServerConstants.RazorMapTextChangesEndpoint)]
internal partial class RazorMapTextChangesEndpoint(IDocumentMappingService documentMappingService, ITelemetryReporter telemetryReporter, ILoggerFactory loggerFactory) :
    IRazorDocumentlessRequestHandler<RazorMapTextChangesParams, RazorMapTextChangesResponse?>,
    ITextDocumentIdentifierHandler<RazorMapToDocumentEditsParams, Uri>
{
    ...
    public Uri GetTextDocumentIdentifier(RazorMapTextChangesParams request)
    {
        return request.RazorDocumentUri;
    }

    public async Task<RazorMapToDocumentEditsResponse?> HandleRequestAsync(RazorMapTextChangesParams request, RazorRequestContext requestContext, CancellationToken cancellationToken)
    {
