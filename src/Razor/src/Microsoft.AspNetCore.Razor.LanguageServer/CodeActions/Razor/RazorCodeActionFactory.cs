...
internal static class RazorCodeActionFactory
{
    ...
    private readonly static Guid s_createExtractToComponentBehindTelemetryId = new("af67b0a3-f84b-4808-97a7-b53e85b22c64");
    ...
    public static RazorVSInternalCodeAction CreateExtractToComponentBehind(RazorCodeActionResolutionParams resolutionParams)
    {
        var title = SR.ExtractTo_ComponentBehind_Title;
        var data = JToken.FromObject(resolutionParams);
        var codeAction = new RazorVSInternalCodeAction()
        {
            Title = title,
            Data = data,
            TelemetryId = s_createExtractToComponentBehindTelemetryId,
        };
        return codeAction;
    }
