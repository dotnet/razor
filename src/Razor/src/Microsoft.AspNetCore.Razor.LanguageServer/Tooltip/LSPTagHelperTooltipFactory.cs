...
{
    internal class LSPTagHelperTooltipFactory : TagHelperTooltipFactoryBase<MarkupContent>
    {
        ...
        public LSPTagHelperTooltipFactory(ClientNotifierServiceBase languageServer)
        {
