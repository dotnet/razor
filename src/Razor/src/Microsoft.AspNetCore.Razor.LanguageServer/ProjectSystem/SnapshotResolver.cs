...
internal class SnapshotResolver : ISnapshotResolver
{
    ...
    public SnapshotResolver(ProjectSnapshotManager projectManager, ILoggerFactory loggerFactory)
    {
    ...
    {
        var miscellaneousProject = _projectManager.GetLoadedProject(MiscellaneousHostProject.Key);
        if (miscellaneousProject is null)
        {
            _projectManager.ProjectAdded(MiscellaneousHostProject);
            miscellaneousProject = _projectManager.GetLoadedProject(MiscellaneousHostProject.Key).AssumeNotNull();
        }
