...
export class ReportIssuePanel {
    ...
    <li><a href="https://github.com/dotnet/aspnetcore/issues/new?template=bug_report.md&labels=area-razor.tooling%2C+feature-razor.vscode%2C+bug">Go to GitHub</a>,
