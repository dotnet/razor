...
{
    public static readonly (IProjectEngineFactory, ICustomProjectEngineFactoryMetadata)[] Factories =
        new (IProjectEngineFactory, ICustomProjectEngineFactoryMetadata)[]
        {
