...
namespace Microsoft.CodeAnalysis.Remote.Razor
{
    ...
    internal static class ServiceDescriptors
    {
        ...
        {
            Debug.Assert(serviceInterface.IsInterface);
            var interfaceName = serviceInterface.Name;
            Debug.Assert(interfaceName.StartsWith(InterfaceNamePrefix, StringComparison.Ordinal));
            Debug.Assert(interfaceName.EndsWith(InterfaceNameSuffix, StringComparison.Ordinal));
