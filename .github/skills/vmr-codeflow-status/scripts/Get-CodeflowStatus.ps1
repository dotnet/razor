...
.PARAMETER Repository
    Target repository (default: dotnet/razor). Format: owner/repo.
...
.EXAMPLE
    ./Get-CodeflowStatus.ps1 -PRNumber 52727 -Repository "dotnet/razor"

.EXAMPLE
    ./Get-CodeflowStatus.ps1 -PRNumber 52727 -Repository "dotnet/razor" -TraceFix "dotnet/runtime#123974"
...
param(
    ...
    [string]$Repository = "dotnet/razor",
...
if ($Repository -notmatch '^[A-Za-z0-9_.-]+/[A-Za-z0-9_.-]+$') {
    Write-Error "Repository must be in format 'owner/repo' (e.g., 'dotnet/razor')"
    return
}
